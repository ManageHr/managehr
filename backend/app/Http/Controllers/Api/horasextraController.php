...
class HorasextraController extends Controller
{
    ...
    /**
     * @OA\Patch(
     *     path="/api/horasextra/{id}/estado",
     *     summary="Actualizar el estado de una solicitud de horas extra",
     *     description="Actualiza solo el campo 'estado' de una solicitud de horas extra.",
     *     tags={"Horas Extra"},
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *         name="id",
     ...
     *         @OA\JsonContent(
     *             required={"estado"},
     *             @OA\Property(property="estado", type="integer", enum={0,1,2}, description="Nuevo estado: 0 (Pendiente), 1 (Aprobado), 2 (Rechazado}")
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     *     @OA\Response(
     *         response=404,
     *         description="Horas extra no encontrada"
     *     )
     * )
     */
