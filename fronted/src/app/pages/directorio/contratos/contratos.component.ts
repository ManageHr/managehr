...
export class ContratosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Paralelizamos ambas peticiones
    forkJoin({
      contratos: this.contratosService.obtenerContratos(),
      areas: this.contratosService.obtenerAreas(),
    }).subscribe({
      next: ({ contratos, areas }) => {
    ...
    this.obtenerTiposContrato(); // sigue por separado si no depende de los anteriores
  }
